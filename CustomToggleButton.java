...
public class CustomToggleButton extends CompoundButton {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.CustomToggleButton);
        color_on = a.getColor(R.styleable.CustomToggleButton_onColor, Color.GREEN);
        color_off = a.getColor(R.styleable.CustomToggleButton_offColor, Color.LTGRAY);
        padding = a.getDimension(R.styleable.CustomToggleButton_padding, 1);
        a.recycle();
    }
